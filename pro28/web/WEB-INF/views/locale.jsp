...
<input type=button value="<spring:message code='btn.send' text="no send"/>" />
<input type=button value="<spring:message code='btn.cancel' text="no cancel"/>" />
<input type=button value="<spring:message code='btn.finish' text="no finish"/>" />
